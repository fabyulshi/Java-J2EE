...
<section id="inner-headline">
	...
	<div class="row">
          ...
          <form name="sentMessage"  method="post" action="decrypt.jsp" id="demoForm" class="demoForm">
	       <h3><a href="" style="text-decoration:none">File Decrypting</a></h3>
		  ...
		  <label>public parameter ( pars )</label><div class="control-group">
			...
			<input type="text" value="<%=new String(Label)%>" class="form-control" 
			  ...
			  <label>Private Key  ( skA )</label><div class="control-group">
                    <div class="controls">
			<input type="text" value=<%=sk%> class="form-control" 
			   	  id="name" name="pars" required
			          />
			  <p class="help-block"></p>
		   </div>
	         </div> 	
		 ...
		 <br>
	    <button type="submit" class="btn btn-primary pull-right">Decrypt</button><br />
          </form>
