...
<section id="inner-headline">
	...
	<div class="row">
		   ...
		   <!-- Form itself -->
          <form name="sentMessage"  method="post" action="reEnc2.jsp" id="demoForm" class="demoForm">
	       <h3>
		 ...
		 <label>public parameter ( pars )</label><div class="control-group">
			...
			<input type="text" value=<%=pars%> class="form-control" 
			 ...
			 <textarea rows="10" cols="100" class="form-control" 
			   ...
			   <label>Trapdoor Key ( skT )</label><div class="control-group">
                    <div class="controls">
			<input type="text" value=<%=r1.getString(6)%> class="form-control" 
			   	  id="name" name="skt" required
			           />
			  <p class="help-block"></p>
		   </div>
	         </div> 
			...
			<input type="text" value="<%=r1.getString(3)%>" class="form-control" 
			 ...
			 <label>Access Structure ( A' )</label> <div class="control-group">
                  <div class="controls">
			 <textarea style="width:100%; min-height:40px;font-size:13px; border-box;box-sizing: border-box;" id="ids" readonly  name="ids"  class="special" class="form-control" ><%=r1.getString(7)%></textarea>
					    <p class="help-block"></p>
		</div>
	    </div> 	
		 ...
		 <br>
	    <button type="submit" class="btn btn-primary pull-right">Re-Encryption</button><br />
          </form>
